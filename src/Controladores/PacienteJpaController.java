...
public class PacienteJpaController implements Serializable {
    ...
    public int getPacienteCount() {
     ...
     public List<Paciente> findPAcienteByDni(int n) {
        EntityManager em = getEntityManager();
        try {
            //la query usada es de hql -- revisar
            Query q = em.createQuery("SELECT p FROM Paciente p WHERE p.dni = :n");
            q.setParameter("n", n);
            return q.getResultList();
        } finally {
            em.close();
    ...
    public boolean findPAcienteByDniIfExist(int n)
    {
        EntityManager em = getEntityManager();
        try {
            //la query usada es de hql -- revisar
